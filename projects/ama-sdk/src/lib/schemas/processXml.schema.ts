/* tslint:disable */
const processXmlSchema = `<?xml version="1.0" encoding="UTF-8" ?>
...
export function getTextBeforePointer(model, position) {
  return model.getValueInRange({startLineNumber: 1, startColumn: 1, endLineNumber: position.lineNumber, endColumn: position.column})
}

export const processXmlSchemaNode = stringToXml(processXmlSchema).childNodes[0];
